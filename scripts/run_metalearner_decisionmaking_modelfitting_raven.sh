...
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 1 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim4_ranked_dim4_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_ranking_essinit0.0_annealed_schedulefree
...
## experiment 2
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 2 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=claude_dim4_direction_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_essinit0.0_annealed_schedulefree
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 2 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim4_direction_dim4_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess7.5_std0.1_run=0_direction_essinit0.0_annealed_schedulefree
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 2 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim4_unknown_dim4_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_unknown_essinit0.0_annealed_schedulefree
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 2 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=claude_dim4_unknown_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_essinit0.0_annealed_schedulefree
...
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim2_unknown_dim2_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess4.5_std0.1_run=0_unknown_essinit0.0_annealed_schedulefree

## experiment 4
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 4 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=claude_dim4_direction_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_essinit0.0_annealed_schedulefree
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 4 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim4_direction_dim4_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess7.5_std0.1_run=0_direction_essinit0.0_annealed_schedulefree
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 4 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim4_unknown_dim4_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_unknown_essinit0.0_annealed_schedulefree
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 4 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=claude_dim4_unknown_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_essinit0.0_annealed_schedulefree4
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 4 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=claude_dim4_ranked_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_essinit0.0_annealed_schedulefree
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --exp-id 4 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=synthetic_dim4_ranked_dim4_model=transformer_num_episodes1000000_num_hidden=8_lr0.0003_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_ess0.0_std0.1_run=0_ranking_essinit0.0_annealed_schedulefree
