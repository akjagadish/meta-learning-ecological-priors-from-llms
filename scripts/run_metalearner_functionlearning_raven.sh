...
# BMI
# python mi/train_functionlearning.py --env-name synthetic_dim1_maxsteps25 --synthetic --num-episodes 100000 --ess ${SLURM_ARRAY_TASK_ID} --optimizer schedulefree --offset 0 --scale 0.5 --job-array --ess-init 0.0 --annealing-fraction 0.167 --max-steps 25 --num-dims 1 --loss nll --save-dir /u/ajagadish/ermi/functionlearning/trained_models/ --save-every 100 --print-every 10  --first-run-id 0 --noise 0.01 --model-name transformer --num_hidden 8 --num_layers 2 --d_model 64 --num_head 8 --batch_size 64 --shuffle 
# BERMI
python mi/train_functionlearning.py --env-type claude_dim1_maxsteps25  --num-episodes 100000 --ess ${SLURM_ARRAY_TASK_ID} --optimizer schedulefree --offset 0 --scale 0.5 --job-array --ess-init 0.0 --annealing-fraction 0.167 --max-steps 25 --num-dims 1 --sample-to-match-max-steps --loss nll --env-name claude_generated_functionlearningtasks_paramsNA_dim1_data20_tasks9991_run0_procid0_pversion2 --env-dir /u/ajagadish/ermi/functionlearning/data/generated_tasks --save-dir /u/ajagadish/ermi/functionlearning/trained_models/ --save-every 100 --print-every 10  --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 8 --num_layers 2 --d_model 64 --num_head 8 --batch_size 64 --shuffle 
# MI
