...
python mi/fit_humans.py --paradigm categorisation --task-name devraj2022 --find-best-model
...
#BERMI
# python mi/fit_humans.py --paradigm categorisation --task-name devraj2022 --optimizer grid_search --ess ${SLURM_ARRAY_TASK_ID} --offset 0 --scale 0.5 --paired --method bounded --use-base-model-name --model-name env=claude_generated_tasks_paramsNA_dim6_data500_tasks12910_pversion5_stage2_model=transformer_num_episodes500000_num_hidden=256_lr0.0003_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_lossbce_ess1.0_run=2_regall_essinit0.0_annealed