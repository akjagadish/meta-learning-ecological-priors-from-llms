...
# python mi/train_functionlearning.py --env-type claude_dim1_maxsteps25 --num-episodes 100000 --max-steps 25 --ess 0 --offset 0 --scale 0 --job-array --ess-init 0.0 --optimizer adam --num-dims 1 --sample-to-match-max-steps --loss nll --env-name claude_generated_functionlearningtasks_paramsNA_dim1_data20_tasks9991_run0_procid0_pversion2 --env-dir /u/ajagadish/ermi/functionlearning/data/generated_tasks --save-dir /u/ajagadish/ermi/functionlearning/trained_models/ --save-every 100 --print-every 10  --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle 
python mi/train_functionlearning.py --env-type claude_dim1_maxsteps25 --num-episodes 100000 --max-steps 25 --ess 0 --offset 0 --scale 0 --job-array --ess-init 0.0 --optimizer schedulefree --num-dims 1 --sample-to-match-max-steps --loss nll --env-name claude_generated_functionlearningtasks_paramsNA_dim1_data20_tasks9991_run0_procid0_pversion2 --env-dir /u/ajagadish/ermi/functionlearning/data/generated_tasks --save-dir /u/ajagadish/ermi/functionlearning/trained_models/ --save-every 100 --print-every 10  --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle 
# MI
