...
induce_pseudo_condition_llm_generated_data(condition='ranked',regress_all=True)
induce_pseudo_condition_llm_generated_data(condition='direction',regress_all=True)
